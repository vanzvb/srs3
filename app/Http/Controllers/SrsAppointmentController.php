...
class SrsAppointmentController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('srs.appoinment.create', ['srsNumber' => $srsRequest->request_id, 'srn' => Crypt::encrypt($srsRequest->request_id)]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // DB::rollBack();
            // dd($apptTimeslot->appointments_count, $dailyApptTime,'hello');
            ...
            DB::rollBack();
            return response()->json(['status' => 0, 'msg' => 'Failed to set appointment', 'error' => $e->getMessage()]);
        }
    }
