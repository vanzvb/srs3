...
class SrsRequestController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('srs.request.create', compact('categories', 'cities'));
    ...
    public function store(SrsRequestRequest $request)
    {
        ...
        $srsRequest->middle_name =  strip_tags(Str::title(trim(preg_replace('/\s+/', ' ', $data['middle_name']))));
        $srsRequest->house_no = strip_tags(Str::title(trim(preg_replace('/\s+/', ' ', $data['house_no']))));
