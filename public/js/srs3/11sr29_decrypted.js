$(document).ready(function () {
    ...
    let vehicleOwnershipType = $("#vehicle_tab").find("#v_vot_tab").clone().html();
    let otherReq = $("#vehicle_tab").find("#v_otherReq_tab").clone().html();
    ...
    addVehicle = (_0x1fd64f = 1) => {
        _0x5f50b5++;
        let _0x58cdc9 = '';
      
        for (let _0xd0a980 = 0; _0xd0a980 < _0x1fd64f; _0xd0a980++) {
          _0x58cdc9 += `
