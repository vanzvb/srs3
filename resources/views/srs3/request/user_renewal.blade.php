                ...
                <div class="container justify-content-center align-items-center">
                    <div class="px-md-4 mt-3 mb-3">
                        <form action="{{ route('request.user-renewal.process') }}" id="renewal_request_form" method="POST"
                            ...
                            {{-- Modals --}}
                            <form action="{{ route('saveProgress') }}" method="POST" id="renewal_request_form">
                                @csrf
                                @foreach ($crm->vehicles as $vehicle)
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="viewDetailsModalLabel-{{ $vehicle->id }}">
                                                        For Renewal</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="px-3 py-1">
                                                                <div class="form-check">
                                                                    <input class="form-check-input new_color"
                                                                        type="checkbox"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 p-2">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                name="first_name_{{ $loop->index }}"
                                                                placeholder="Enter First Name"
                                                                value="{{ session('first_name_' . $loop->index) ?? '' }}">
                                                        </div>
                                                        <div class="col-md-4 p-2">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                name="middle_name_{{ $loop->index }}"
                                                                placeholder="Enter Middle Name"
                                                                value="{{ session('middle_name_' . $loop->index) ?? '' }}">
                                                        </div>
                                                        <div class="col-md-4 p-2">
                                                            <label for="last_name" class="form-label"><b>Last
                                                                    Name</b></label>
                                                            <input type="text" class="form-control"
                                                                id="last_name_{{ $loop->index }}"
                                                                name="last_name_{{ $loop->index }}"
                                                                placeholder="Enter Last Name"
                                                                value="{{ session('last_name_' . $loop->index) ?? '' }}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 p-2">
                                                            <label for="hoa"
                                                                class="form-label"><b>Category</b></label>
                                                            <select class="form-select" name="hoa" id="hoa">
                                                                <option value="" style="color: grey;"
                                                                    {{ !$crmHoaId ? 'selected' : '' }}>Please select
                                                                    Category
                                                                </option>
                                                                {{-- @foreach ($hoas as $hoa)
                                                            <option value="{{ $hoa->id }}" {{ $hoa->id == $crmHoaId ? 'selected' : ''}}>{{ $hoa->name }}</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 p-2">
                                                            <label for="middle_name" class="form-label"><b>Main Contact
                                                                    No.</b></label>
                                                            <input type="text" class="form-control" id="middle_name"
                                                                name="middle_name" placeholder="Enter Contact No.">
                                                        </div>
                                                        <div class="col-md-3 p-2">
                                                            <label for="last_name" class="form-label"><b>Seconday Contact
                                                                    No.</b></label>
                                                            <input type="text" class="form-control" id="last_name"
                                                                name="last_name" placeholder="Enter Seconday Contact No">
                                                        </div>
                                                        <div class="col-md-3 p-2">
                                                            <label for="last_name" class="form-label"><b>Tertiary Contact
                                                                    No.</b></label>
                                                            <input type="text" class="form-control" id="last_name"
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-primary"
                                                        data-bs-dismiss="modal" id="save_btn">Save</button>
