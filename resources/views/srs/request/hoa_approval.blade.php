                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 col-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    {{-- <a data-value="/sticker/requests/uploads/{{$vehicle->cr}}/{{$srsRequest->created_at->format('Y-m-d')}}/{{$srsRequest->first_name.'_'.$srsRequest->last_name}}/{{($srsRequest->hoa_id ?: '0')}}/{{$srsRequest->category_id}}" data-type="{{ (explode('.', $vehicle->cr)[1] ?? '' == 'pdf' ? 'pdf' : 'img')}}" href="#" class="modal_img">CR</a> --}}
                                                    <a data-value="{{ ($vehicle->cr_from_crm ? '/crm_model/cr/' . $vehicle->cr : '/sticker/requests/uploads/' . $vehicle->cr_path) }}" data-type="{{ ($vehicle->cr ? (explode('.', $vehicle->cr)[1] == 'pdf' ? 'pdf' : 'img') : 'img' )}}" href="#" class="modal_img">CR</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
$(document).ready(function () {
    $('#approve_btn').on('click', function (e) {
        ...
        $('#request_load').show();
        $.ajax({
            url: '{{ route("requests.hoa.approved") }}',
            type: 'POST',
            data: {
